...
with DAG(
    ...
    # Save File Paths
    base_path = os.getenv("AIRFLOW_HOME", "/opt/airflow")
    final_save_path = os.path.join(base_path, "data/SP500/reports/firm")
    ...
    # Input File
    extracted_folder = os.path.join(base_path, "data/SP500/reports/firm/json")
    ...
    def sent_predictor(window, **kwargs):
        ...
        config = {
            ...
            "fig_loc": os.path.join(os.getenv("AIRFLOW_HOME", "/opt/airflow"), "data/SP500/reports/firm/outcome/figures"),
            "input_path": os.path.join(os.getenv("AIRFLOW_HOME", "/opt/airflow"), "data/SP500/reports/firm/processed/dtm_0001045810.parquet"),
            "window": window,
            }
    ...
    t1_download_id_executor >> t2_download_executor >> t3_dtm_constructor >> t4_sent_predictor
