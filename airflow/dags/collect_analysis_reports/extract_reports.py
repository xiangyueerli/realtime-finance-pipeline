...
# Global variables
save_folder_name = "analysis_reports"
save_folder = f'/opt/airflow/data/AnalysisReports/{save_folder_name}'

id_folder = "/data/seanchoi/airflow/data/AnalysisReports/analysis_report_ids"
year_until = 2024
year_since = 2006
total_len = 0
valid = 0
...
# File path for CSV
path = '/data/seanchoi/airflow/data/sp500_total_constituents.csv'
log_folder_path = '/data/seanchoi/airflow/data/logs'
