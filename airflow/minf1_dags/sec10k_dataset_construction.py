...
from seanchoi.airflow.plugins.packages.FTRM.annual_report_reader import reader
from seanchoi.airflow.plugins.packages.PDCM.vol_reader_fun import vol_reader, vol_reader2
        ...
        for cik in self.firms_ciks:
            ...
            for filename in os.listdir(folder_path):
                if filename.rsplit('.', 1)[0] == cik:
                    ...
                    D_comp.index = D_comp.index.tz_localize('UTC') #
                    ...
                    # vol_comp.index = vol_comp.index.tz_localize('UTC') #
