...
with DAG(
    ...
    data_raw_folder = f'/opt/airflow/data/NASDAQ100/{level}_{type}_html'
    sec10k_10k_extracted_folder = f'/opt/airflow/data/NASDAQ100/{level}_{type}_all_txt'
    sec10k_item1a_extracted_folder = f'/opt/airflow/data/NASDAQ100/{level}_{type}_riskFactor_txt'
    ...
    def sec10k_extraction_executor(data_folder, save_folder):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=os.cpu_count()) as executor:
            futures = []
            print('filing - len(os.listdir(data_folder)):', len(os.listdir(data_folder)))
    ...
    def item1a_executor(data_folder, save_folder):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=os.cpu_count()) as executor:
            futures = []
            print('risk factor - len(os.listdir(data_folder)):', len(os.listdir(data_folder)))
            for cik in os.listdir(data_folder):
